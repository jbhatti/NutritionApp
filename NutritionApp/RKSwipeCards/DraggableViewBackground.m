...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        exampleCardLabels = [[NSArray alloc]initWithObjects:@"Whey",@"Chicken",@"Pink Beans",@"Fish",@"Black Beans", @"Dark Meat", @"Pork", @"Adzuki Beans", @"Peanuts", @"McDonalds Grilled Chicken", nil]; //%%% placeholder for card-specific information
...
-(DraggableView *)createDraggableViewWithDataAtIndex:(NSInteger)index
{
    ...
    draggableView.photo.image = [photos objectAtIndex:index]; /////
